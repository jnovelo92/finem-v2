      ...
      >
        ...
        <motion.div variants={itemVariants} className="max-w-2xl mb-12">
          <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
            No venimos a "llevar redes sociales". Vamos a construir el <span className="text-white font-medium">prestigio digital</span> que corresponde a la red hospitalaria más importante del destino.
          </p>
        </motion.div>
            ...
            <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-orange-500/10 via-[#0a0a1a] to-purple-500/10 border border-white/10 overflow-hidden">
              ...
              <div className="absolute inset-0 hidden items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-slate-400 text-sm">Infraestructura Amerimed</p>
                </div>
              </div>
              {/* Overlay */}
              ...
              <div className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-orange-500/20 border border-orange-500/30 backdrop-blur-sm">
                <span className="text-orange-400 text-xs font-bold">Nivel 3</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-6 mb-10">
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed">
                Tu comunicación actual está volcadas al <span className="text-orange-400 font-semibold">Mercado Local</span> (Promociones/Descuentos). Esto asegura tu base operativa, pero es invisible para el <span className="text-white font-semibold">Turista Internacional</span>.
              </p>

              <p className="text-slate-400 leading-relaxed">
                El paciente extranjero no busca promociones; busca <span className="text-white">Seguridad</span> y <span className="text-white">Infraestructura</span>. Al no mostrar esto, estás dejando dinero sobre la mesa, mientras que el mercado local te sostiene en temporadas bajas.
              </p>
            </div>

            <div className="p-6 rounded-xl bg-white/[0.03] border border-orange-500/20">
              <p className="text-orange-400 font-semibold mb-2">La Solución Híbrida:</p>
              <p className="text-white leading-relaxed">
                No elegiremos una audiencia sobre la otra. Ejecutaremos una <span className="text-orange-400">Estrategia de Doble Carril</span>: Fidelización Local para estabilidad + Autoridad Internacional para rentabilidad.
              </p>
            </div>
          </motion.div>
        </motion.div>
...
const MethodSection = memo(() => {
  ...
  const motorItems = [
    {
      icon: Users,
      title: "Carril 1: Mercado Local",
      description: "Contenido de cercanía, promociones y comunidad. Objetivo: Mantener el flujo base y lealtad ante contingencias.",
    },
    {
      icon: Globe,
      title: "Carril 2: Mercado Turístico",
      description: "Contenido 'High-End' en inglés/español neutro. Mostramos tecnología e instalaciones. Objetivo: Confianza y Seguridad.",
    },
    {
      icon: Target,
      title: "Segmentación Quirúrgica",
      description: "El turista NO verá las promos locales. El local NO verá contenido irrelevante. Cada audiencia en su canal.",
    },
    {
      icon: Shield,
      title: "Gestión de Reputación",
      description: "Protocolos de respuesta para blindar la marca en Google (Vital para el extranjero).",
    },
  ];

  const fabricaItems = [
    { phase: "Mes 1", title: "Unificación de Identidad Visual & Tono", icon: Palette },
    { phase: "Mes 2-3", title: "Campaña: Turismo Médico & Urgencias", icon: Globe },
    { phase: "Mes 4", title: "Landing Pages por Especialidad (High Ticket)", icon: Rocket },
  ];
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-slate-400 text-lg md:text-xl max-w-2xl leading-relaxed">
            Olvide el modelo de "proveedor externo". Amerimed necesita una <span className="text-white font-medium">Torre de Control</span>.
            Integramos la visión corporativa con la operación local:
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-slate-400 text-lg">
                La maquinaria operativa. Garantizamos <span className="text-white">visibilidad constante</span> y profesionalismo.
              </p>
            </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-slate-400 text-lg">
                Mientras operamos el día a día, construimos su infraestructura digital mes a mes para que <span className="text-white">su activo crezca</span>.
              </p>
            </motion.div>
...
const RoadmapSection = memo(() => {
  const phases = [
    {
      number: "01", title: "Estandarización", timeline: "Mes 1", icon: Shield,
      ...
      objetivo: "Ordenar y profesionalizar la imagen de las 7 sedes.",
      entregable: "Manual de Uso Digital + Optimización de perfiles + Protocolos de Respuesta a pacientes.",
    },
    {
      number: "02", title: "Humanización", timeline: "Mes 2-3", icon: Heart,
      gradient: "from-blue-500/20 to-blue-600/10", borderColor: "border-blue-500/30",
      iconBg: "bg-blue-500/20", iconColor: "text-blue-400",
      objetivo: "Generar confianza mostrando a sus especialistas y tecnología.",
      entregable: "Contenido de alto valor (Casos de éxito, Tecnología) + Difusión Local.",
    },
    {
      number: "03", title: "Adquisición", timeline: "Mes 4-5", icon: Target,
      ...
      objetivo: "Captación activa de pacientes privados y aseguradoras.",
      entregable: "Estrategia para Check-ups, Maternidad y Urgencias + Publicidad en Google.",
    },
    {
      number: "04", title: "Expansión", timeline: "Mes 6+", icon: TrendingUp,
      gradient: "from-teal-500/20 to-teal-600/10", borderColor: "border-teal-500/30",
      iconBg: "bg-teal-500/20", iconColor: "text-teal-400",
      objetivo: "Posicionamiento Regional.",
      entregable: "Estrategia de Turismo Médico (USA/Canadá).",
    },
  ];
...
const InvestmentSection = memo(() => {
  ...
  const scenarios = {
    A: {
      icon: Shield,
      title: "Blindaje & Estabilidad",
      subtitle: "(El Mercado Local)",
      color: "orange",
      description: "Garantizamos la continuidad operativa. No rompemos lo que ya funciona con el local, lo profesionalizamos.",
      items: [
        "Mantenimiento de campañas locales (Promociones/Membresías).",
        "Atención a la comunidad en contingencias (Huracanes/Temporada baja).",
        "Diseño gráfico superior para diferenciarte de consultorios genéricos."
      ],
      resultado: "Tu base de pacientes locales se mantiene firme y segura, protegiendo los costos fijos del hospital.",
    },
    B: {
      icon: TrendingUp,
      title: "Liderazgo de Mercado",
      subtitle: "(Escenario Ideal)",
      color: "purple",
      description: "La marca pasa de la defensa al ataque. No solo nos vemos bien, sino que influimos en la decisión de compra del paciente privado y turista médico.",
      items: [
        "Captación Activa: Estrategias de Check-ups y Urgencias Turísticas.",
        "Autoridad Digital: Los especialistas de Amerimed se vuelven referentes locales.",
        "Data Intelligence: Reportes de qué plazas y servicios son más rentables."
      ],
      highlight: "OBJETIVO: TOP OF MIND REGIONAL",
      resultado: "La marca se convierte en un imán de pacientes High-Ticket, justificando la inversión con ingresos directos hospitalarios.",
    }
  };
    ...
    <section className="relative py-24 md:py-32">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <motion.div className="mb-16 md:mb-20" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
          ...
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-white leading-[1.1] mb-6">
            Proyección de<br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-500">Valor y Retorno</span>
          </motion.h2>

          <motion.p variants={itemVariants} className="text-slate-400 text-lg max-w-2xl">
            Tu inversión de $60,000 MXN no es un gasto, es el combustible de tu reputación. Así es como se ve el éxito en dos horizontes:
          </motion.p>
        </motion.div>
        ...
        <motion.div className="mb-12" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
          <div className="p-6 md:p-8 rounded-2xl bg-white/[0.03] border border-white/10">
            <p className="text-slate-400 text-sm uppercase tracking-widest mb-2">Replicar esta estructura con 7 agencias individuales costaría</p>
            <p className="text-3xl md:text-4xl font-bold text-white">$105,000+ <span className="text-lg text-slate-400 font-normal">MXN/mes</span></p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className={`p-8 md:p-10 rounded-2xl border ${scenarios[activeScenario].color === 'orange'
...
const OfferSection = memo(() => {
  const includes = [
    { icon: Users, text: "Gerente de Cuenta Dedicado (Su enlace directo)" },
    { icon: Shield, text: "Gestión de Reputación y Crisis" },
    { icon: Palette, text: "Diseño Gráfico Corporativo y Adaptaciones Locales" },
    { icon: Target, text: "Estrategia de Publicidad Digital (Meta Ads)" },
  ];
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
          ...
          <motion.p variants={itemVariants} className="text-slate-400 text-lg max-w-2xl mx-auto mb-12">
            Centralizamos la operación de Cancún, Playa, Cozumel, Mérida, CDMX, Tulum e Isla Mujeres en un solo equipo estratégico.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="relative p-10 md:p-12 rounded-3xl bg-gradient-to-br from-orange-500/10 via-[#0a0a1a] to-purple-500/10 border border-orange-500/20 overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-slate-400 text-sm uppercase tracking-widest mb-4">Iguala Mensual Corporativa</p>
              <div className="flex items-baseline justify-center gap-2 mb-4">
                <span className="text-6xl md:text-8xl font-black text-white">$60,000</span>
                <span className="text-2xl text-slate-400 font-light">MXN</span>
              </div>
              <p className="text-slate-500 text-sm">(+ IVA)</p>
              <p className="text-orange-400 text-xs mt-2 font-bold">*No incluye el pago directo a las plataformas de anuncios ni viáticos para producción foránea.</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
...
const CTASection = memo(() => {
  const steps = ["Aprobación del Plan de Trabajo", "Firma de Acuerdo", "Inicio Inmediato: Auditoría de Marca (Semana 1)"];
    ...
    <section id="cta" className="relative py-24 md:py-32">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
          ...
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-white leading-[1.1] mb-6">
            ¿Listos para elevar el estándar?
          </motion.h2>

          <motion.p variants={itemVariants} className="text-slate-400 text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
            La infraestructura médica de primer nivel ya la tienen. Ahora hagamos que el mundo lo vea.
          </motion.p>
    ...
    <div className="container mx-auto px-6 max-w-6xl">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex items-center gap-4">
          ...
          <span className="text-slate-600 text-sm">Propuesta Exclusiva Amerimed 2026</span>
        </div>
...
export default AmerimedProposal;